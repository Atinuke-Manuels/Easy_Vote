...
class UpdateElectionsLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout.builder(
      ...
      tablet: (BuildContext context) =>  UpdateElectionScreen(election: Election(id: '', title: '', candidates: [], startDate: DateTime.now(), endDate: DateTime.now().add(Duration(days: 7)), registeredVoters: [], creatorId: '')),
    );
  }
}
